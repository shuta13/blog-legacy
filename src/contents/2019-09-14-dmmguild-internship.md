...
<a href="" target="_blank">Figma</a>というデザインツールがあります。開発チームがこれを採用していたので、使用しました
...
なのでいい感じにデザインできそうなプレゼンツールを探し、<a href="" target="_blank">beautiful.ai</a>を使用することにしました
...
プレゼンは滞りなく進み、様々な講評を頂きましたが概ね良い感じの意見をいただけたので良かったです。デザイナー大変だけど楽しい
